...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_delta', type=float, default=-0.002, help='early stopping min_delta')
    ...
    parser.add_argument('--project', type=str, help='options=[conv, linear]', default='linear')
    parser.add_argument('--temporal_encoding', action='store_true', default=False)
    parser.add_argument('--time_encoding', action='store_true', default=False)
    parser.add_argument('--n_vars', type=int, default=0)
    
    # Delayformer hyper-params
